...
---
Además, esta semana he estado analizando y probando el repositorio desarrollado por [@2025-tfg-joan-aristizabal](https://github.com/RoboticsLabURJC/2025-tfg-joan-aristizabal), concretamente el módulo [brain_predict](https://github.com/RoboticsLabURJC/2025-tfg-joan-aristizabal/tree/main/brain_predict). El repositorio se centra en la fase de inferencia dentro de un módulo de percepción para conducción autónoma, donde el “brain” actúa como módulo de decisión/predicción a partir de las entradas sensoriales procesadas previamente. 
