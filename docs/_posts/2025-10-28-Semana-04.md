...
Durante esta cuarta semana he implementado un **sistema integral de simulación, adquisición y análisis de datos LiDAR en CARLA**, con detección automática de **superficies planas** en tiempo real y procesamiento posterior optimizado. He intentado sin éxito crear un escenario simplificado, al no conseguirlo he optado por probarlo con un ejemplo predeterminado pero situado en una calle que cumplía con mis especificaciones.
![CIUDAD](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/PARCHES4.png?raw=true)
...
---
![CIUDAD](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/PARCHES3.png?raw=true)![CIUDAD](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/PARCHES1.png?raw=true)
![CIUDAD](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/PARCHES2.png?raw=true)
