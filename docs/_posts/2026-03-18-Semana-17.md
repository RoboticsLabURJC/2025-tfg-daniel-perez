...
---
Para continuar con la validación del método se ha probado también con el dataset de **GOOSE**, un total de 96 escenas diferentes. Se ha cambiado la *ontology* para que corresponda con el dataset. Dado que este dataset presenta una calibración inicial menos precisa, los efectos del algoritmo resultan más notorios, mostrando mayores desplazamientos respecto a las escenas de *RELLIS*. Los resultados se recogen [aquí](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/tree/main/docs/RESULTADOS_GOOSE). 

Aquí algunos resultados del método:

### Escena 1
![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/GOOSE_1_COMPOSITE.png?raw=true)

### Escena 2
![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/GOOSE_2_COMPOSITE.png?raw=true)


### Escena 3
![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/GOOSE_3_COMPOSITE.png?raw=true)
