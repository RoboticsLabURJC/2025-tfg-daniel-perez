...
Se han usado las siguientes imágenes sintéticas creadas con la herramienta [**FIGMA**](https://help.figma.com/hc/es-419/articles/14563969806359--Qu%C3%A9-es-Figma), la imagen de la izquierda corresponde con nuestra base y la de la derecha el recorte trasladado y rotado que intentamos alinear.

## PRUEBA 1:
Para una primera prueba se ha usado la siguiente imagen sintética creada con la herramienta [**FIGMA**](https://help.figma.com/hc/es-419/articles/14563969806359--Qu%C3%A9-es-Figma), la imagen de la izquierda corresponde con nuestra base y la de la derecha el recorte trasladado y rotado que intentamos alinear.

![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/COMPARACION_SUP.png?raw=true)

Se obtienen los siguientes resultados:

![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/COMPOSICION_RESULTADO_SOLAP.png?raw=true)
...
![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/COMPARACION_SUP_2.png?raw=true)

Se obtienen los siguientes resultados:

![COMPARACION](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/blob/main/docs/assets/images/COMPOSICION_RESULTADO_SOLAP_2.png?raw=true)
