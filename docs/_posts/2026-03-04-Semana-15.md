...
---
Los resultados de los experimentos se recogen en la siguiente tabla y en este [enlace](https://github.com/RoboticsLabURJC/2025-tfg-daniel-perez/tree/main/docs/SemAlign).
...
--- 
Dado que las distintas funciones de pérdida operan en escalas diferentes, la comparación directa de sus valores absolutos no resulta representativa. Por este motivo, se ha calculado la mejora relativa respecto a la pérdida inicial de cada método. Esta métrica se define como la reducción porcentual de la pérdida tras el proceso de optimización. Los resultados obtenidos son unas correciones relativamente pequeñas, ya que, la calibración inicial ya era buena, simplemente se ha realizado un refinamiento fino para mejorarla.
