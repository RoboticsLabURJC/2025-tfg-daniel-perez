...
def evaluate_candidate(
    ...
    loss, valid_pts, info_cls = semantic_alignment_loss_chamfer(
        uv,
        z_cam,
        lidar_labels,
        rgb_seg,
...
def main():
    ...
    make_overlay(
        ...
        t=best["t"],
        K=K,
        out_path="overlay_chamfer_unidireciconal_grid.png"
    )
    ...
    with open("best_calibration_chamfer_unidireciconal_grid.json", "w", encoding="utf-8") as f:
