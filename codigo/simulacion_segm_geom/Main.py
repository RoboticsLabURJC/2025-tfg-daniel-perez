...
from DataProcessing2 import process_saved_data_improved
...
def main_improved():
    ...
    try:
        ...
        # Posicionar LiDAR más alto para mejor cobertura
        lidar_location = carla.Location(x=50, y=10, z=2.5)## cambios aqui
        lidar = set_lidar(world, lidar_location)
        actor_list.append(lidar)
        
        # Añadir la cámara RGB al escenario
        camera_location = carla.Location(x=50, y=10, z=2.5)  # Posición de la cámara
